...
function App() {
  ...
  const handleExpenseAdded = () => {
    // Force re-render of components that display expenses
  ...
  return (
    <div style={{ 
      ...
      minHeight: '100vh'
       ...
       {/* Header with Setup Budget Button */}
      <div style={{ 
        display: 'flex', 
        ...
        <button
          ...
          onMouseEnter={(e) => {
            e.target.style.background = '#FF8855';
            e.target.style.color = 'white';
          }}
          onMouseLeave={(e) => {
            e.target.style.background = 'white';
            e.target.style.color = '#FF8855';
          }}
        >
          📊 Setup Budget
        </button>
      ...
      <button
        ...
        style={{
          ...
          height: '64px',
          borderRadius: '50%',
          background: 'linear-gradient(135deg, #FF8855 0%, #E66D3C 100%)',
          color: 'white',
          border: 'none',
          fontSize: '2rem',
          cursor: 'pointer',
